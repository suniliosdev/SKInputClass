...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "SunilSpaceo" => "sunil@spaceotechnologies.com", "other author" => "sunil@spaceotechnologies.com" }
  ...
  s.source       = { :git => "https://github.com/SunilSpaceo/SKInputClass.git", :tag => "1.0" }
